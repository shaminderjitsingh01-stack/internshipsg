        ...
        {showBookmarklet && (
          <div className="mt-4 space-y-4">
            <div className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-xl">
              ...
              <div className="flex items-center gap-3 mb-4">
                <a
                  href={`javascript:(function(){var t=document.body.innerText||document.body.textContent;if(t.length<100){alert('Could not find job description on this page');return;}var e=encodeURIComponent(t.substring(0,15000));window.open('https://internship.sg/job-interview?jd='+e,'_blank')})();`}
              ...
              <div className="mt-4 pt-3 border-t border-blue-200">
                ...
                <div className="relative">
                  <code className="block p-2 bg-white/70 rounded text-[10px] text-blue-900 font-mono break-all border border-blue-200">
                    {`javascript:(function(){var t=document.body.innerText||document.body.textContent;if(t.length<100){alert('Could not find job description');return;}var e=encodeURIComponent(t.substring(0,15000));window.open('https://internship.sg/job-interview?jd='+e,'_blank')})();`}
                  </code>
                  <button
                    onClick={() => {
                      navigator.clipboard.writeText(`javascript:(function(){var t=document.body.innerText||document.body.textContent;if(t.length<100){alert('Could not find job description');return;}var e=encodeURIComponent(t.substring(0,15000));window.open('https://internship.sg/job-interview?jd='+e,'_blank')})();`);
