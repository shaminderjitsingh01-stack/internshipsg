...
export default function StreakCard({ streak, title, userName, onClose }: Props) {
  ...
  const getMessage = () => {
    if (streak >= 30) return "Discipline is my superpower.";
    if (streak >= 14) return "Two weeks of investing in my future.";
    if (streak >= 7) return "A full week of showing up.";
    if (streak >= 3) return "Building habits that matter.";
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl max-w-md w-full overflow-hidden shadow-2xl">
        ...
        <div className="bg-gradient-to-br from-orange-500 to-red-600 p-8 text-white text-center">
          ...
          <p className="text-lg opacity-90 mb-4">"{getMessage()}"</p>
