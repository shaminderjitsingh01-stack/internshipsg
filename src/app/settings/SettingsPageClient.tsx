    ...
    <div className="min-h-screen bg-[var(--background)] flex flex-col">
      ...
      <main className="flex-1 pt-24 pb-16 px-4">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6 mb-6">
            ...
            <form onSubmit={handlePasswordChange} className="space-y-4">
              ...
              <button
                ...
                className="px-6 py-3 bg-[#dc2626] text-[var(--foreground)] font-medium rounded-xl hover:bg-[#b91c1c] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
          ...
          <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6 mb-6">
            ...
            <div className="space-y-4">
              <label className="flex items-center justify-between cursor-pointer">
                <div>
                  <p className="text-[var(--foreground)] font-medium">Job Alert Emails</p>
                  <p className="text-sm text-[var(--muted)]">Receive emails when new jobs match your alerts</p>
                </div>
              ...
              <label className="flex items-center justify-between cursor-pointer">
                <div>
                  <p className="text-[var(--foreground)] font-medium">Application Updates</p>
                  <p className="text-sm text-[var(--muted)]">Receive emails when your application status changes</p>
                </div>
                <div className="relative">
                  <input
                    type="checkbox"
              ...
              <label className="flex items-center justify-between cursor-pointer">
                <div>
                  <p className="text-[var(--foreground)] font-medium">Marketing Emails</p>
                  <p className="text-sm text-[var(--muted)]">Receive tips, career advice, and platform updates</p>
                </div>
                <div className="relative">
                  <input
                    type="checkbox"
          ...
          {/* Privacy & Data */}
          <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6 mb-6">
            <h2 className="text-lg font-semibold text-[var(--foreground)] mb-2">Privacy & Data</h2>
          ...
          <div className="bg-zinc-900 border border-red-500/30 rounded-xl p-6">
            ...
            {!showDeleteConfirm ? (
              ...
              <div className="space-y-4">
                <p className="text-[var(--foreground)]">This will permanently delete:</p>
