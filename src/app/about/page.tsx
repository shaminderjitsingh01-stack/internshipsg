    ...
    <div className="min-h-screen bg-[var(--background)] flex flex-col">
      ...
      <main className="flex-1 pt-24 pb-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-[var(--foreground)] mb-8">About internship.sg</h1>
          ...
          <div className="prose prose-zinc max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[var(--foreground)] mb-4">What We Do</h2>
              <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6">
                <ul className="list-disc list-inside text-[var(--foreground)] space-y-3">
                  <li>
                    <strong className="text-[var(--foreground)]">Aggregate Opportunities:</strong> We collect internship listings from company career pages, job boards, and other sources across Singapore.
                  </li>
                  <li>
                    <strong className="text-[var(--foreground)]">Simplify Search:</strong> Our smart filters help you find internships by industry, location, duration, and more.
                  </li>
                  <li>
                    <strong className="text-[var(--foreground)]">Track Applications:</strong> Keep all your applications organized in one dashboard.
                  </li>
                  <li>
                    <strong className="text-[var(--foreground)]">Stay Updated:</strong> Get notified when new internships matching your preferences are posted.
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[var(--foreground)] mb-4">Why internship.sg?</h2>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6">
                  ...
                  <h3 className="text-lg font-medium text-[var(--foreground)] mb-2">Singapore-Focused</h3>
                  <p className="text-[var(--foreground)]">
                ...
                <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6">
                  ...
                  <h3 className="text-lg font-medium text-[var(--foreground)] mb-2">Fast & Simple</h3>
                  <p className="text-[var(--foreground)]">
                ...
                <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6">
                  ...
                  <h3 className="text-lg font-medium text-[var(--foreground)] mb-2">Always Updated</h3>
                  <p className="text-[var(--foreground)]">
                ...
                <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6">
                  ...
                  <h3 className="text-lg font-medium text-[var(--foreground)] mb-2">100% Free</h3>
                  <p className="text-[var(--foreground)]">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[var(--foreground)] mb-4">Our Team</h2>
              <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6">
                <p className="text-[var(--foreground)] mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[var(--foreground)] mb-4">For Employers</h2>
              <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6">
                <p className="text-[var(--foreground)] mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[var(--foreground)] mb-4">Get in Touch</h2>
              <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6">
                <p className="text-[var(--foreground)] mb-4">
