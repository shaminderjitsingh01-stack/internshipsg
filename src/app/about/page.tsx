    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-white">
      ...
      <section className="py-8 sm:py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-8 shadow-sm border border-slate-200">
            <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-4 sm:mb-6">Our Story</h2>
      ...
      <section className="py-8 sm:py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-6 sm:mb-8 text-center">What We Offer</h2>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-slate-200 text-center">
              ...
              <h3 className="font-semibold text-slate-900 mb-2 text-sm sm:text-base">AI Video Interviews</h3>
            ...
            <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-slate-200 text-center">
              ...
              <h3 className="font-semibold text-slate-900 mb-2 text-sm sm:text-base">Resume & Cover Letter</h3>
              <p className="text-xs sm:text-sm text-slate-600">
                Get AI-powered suggestions to improve your resume and craft compelling cover letters.
              </p>
            </div>
            <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-slate-200 text-center sm:col-span-2 md:col-span-1">
              ...
              <h3 className="font-semibold text-slate-900 mb-2 text-sm sm:text-base">Skills Assessment</h3>
              <p className="text-xs sm:text-sm text-slate-600">
      ...
      <section className="py-8 sm:py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-8 shadow-sm border border-slate-200">
            <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-4 sm:mb-6">Why Focus on Singapore?</h2>
            <div className="space-y-3 sm:space-y-4 text-slate-600 leading-relaxed text-sm sm:text-base">
              <p>
      ...
      <section className="py-10 sm:py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base px-2">
