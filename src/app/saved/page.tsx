                  ...
                  <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                    <div className="flex items-start gap-4 flex-1">
                      ...
                      <div className="flex-1 min-w-0">
                        <Link
                          href={`/jobs/${job.slug}`}
                          className="text-lg font-semibold text-white hover:text-[#dc2626] transition-colors block"
                        >
                          {job.title}
                        </Link>
                        ...
                        <div className="flex flex-wrap gap-2 mt-3">
                          <span className="px-3 py-1 text-xs bg-zinc-800 text-zinc-300 rounded-lg border border-zinc-700">
                            {job.location}
                          </span>
                    ...
                    <div className="flex items-center gap-3 md:flex-col md:items-end">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-zinc-800 text-zinc-300 text-sm rounded-lg hover:bg-zinc-700 hover:text-white transition-colors disabled:opacity-50 flex items-center gap-2"
                      >
                        {removing === job.id ? (
                          <>
