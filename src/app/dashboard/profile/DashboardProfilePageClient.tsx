...
export default function DashboardProfilePageClient() {
      ...
      <main className="flex-1 pt-24 pb-16 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl p-6 mb-8">
            <h2 className="text-lg font-semibold text-[var(--foreground)] mb-4">Profile Visibility</h2>

            <div className="space-y-4">
              <label className="flex items-center justify-between cursor-pointer">
                <div>
                  <p className="text-[var(--foreground)] font-medium">Make profile visible to employers</p>
                  <p className="text-sm text-[var(--muted)]">Employers can find and view your profile</p>
                </div>
              ...
              <label className="flex items-center justify-between cursor-pointer">
                <div>
                  <p className="text-[var(--foreground)] font-medium">Open to work</p>
                  <p className="text-sm text-[var(--muted)]">Show a badge that you're actively looking for internships</p>
                </div>
                <div className="relative">
                  <input
                    type="checkbox"
            ...
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {profile.skills.map((skill) => (
                  <span
                    key={skill}
                    className="px-3 py-1.5 bg-zinc-800 text-[var(--foreground)] rounded-lg flex items-center gap-2"
                  >
                    {skill}
                    <button
                      type="button"
                ...
                >
                  {uploading ? (
                    ...
                    <>
                      ...
                      <p className="text-sm text-[var(--muted)] mt-1">PDF or Word, max 5MB</p>
                    </>
                  )}
                </button>
              )}
