          ...
          <div className="prose prose-invert prose-zinc max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 space-y-6">
                <div>
                  <h3 className="text-lg font-medium text-white mb-2">Essential Cookies (Strictly Necessary)</h3>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-white mb-4">3. PDPA Compliance</h2>
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
                <p className="text-zinc-300 mb-4">
            ...
            <section className="mb-8">
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 space-y-4">
                ...
                <div>
                  <h3 className="text-lg font-medium text-white mb-2">Managing Preferences</h3>
                  <p className="text-zinc-300">
