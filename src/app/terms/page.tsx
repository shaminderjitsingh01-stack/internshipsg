          ...
          <div className="prose prose-invert prose-zinc max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 space-y-4">
                <div>
                  <h3 className="text-lg font-medium text-white mb-2">Account Registration</h3>
                  <p className="text-zinc-300">
                ...
                <div>
                  <h3 className="text-lg font-medium text-white mb-2">Account Types</h3>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-white mb-4">4. Job Seeker Terms</h2>
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
                <p className="text-zinc-300 mb-4">As a job seeker, you agree to:</p>
                <ul className="list-disc list-inside text-zinc-300 space-y-2">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-white mb-4">5. Employer Terms</h2>
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
                <p className="text-zinc-300 mb-4">As an employer, you agree to:</p>
                <ul className="list-disc list-inside text-zinc-300 space-y-2">
            ...
            <section className="mb-8">
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
                <p className="text-zinc-300 mb-4">The following activities are strictly prohibited:</p>
                <ul className="list-disc list-inside text-zinc-300 space-y-2">
            ...
            <section className="mb-8">
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 space-y-4">
                <div>
                  <h3 className="text-lg font-medium text-white mb-2">No Guarantee of Employment</h3>
                  <p className="text-zinc-300">
                ...
                <div>
                  <h3 className="text-lg font-medium text-white mb-2">Third-Party Content</h3>
                  <p className="text-zinc-300">
