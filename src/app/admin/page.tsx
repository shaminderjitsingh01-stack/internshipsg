          ...
          <div className="w-full max-w-md">
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-zinc-400 mt-2">Enter password to access</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-zinc-400 mt-1">Monitor and manage internship.sg</p>
            </div>
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-zinc-400">New Jobs Posted</span>
                      <span className="text-2xl font-bold text-white">{stats?.jobsThisMonth || 0}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-zinc-400">Applications Received</span>
                      <span className="text-2xl font-bold text-white">{stats?.applicationsThisMonth || 0}</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-xl">
                    ...
                    <p className="text-zinc-400 text-sm">Cookie consent banner active</p>
                  </div>
                  <div className="p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-xl">
                    <div className="flex items-center gap-2 text-emerald-400 mb-1">
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <p className="text-zinc-400 text-sm">Users can view/export data</p>
                  </div>
                  <div className="p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-xl">
                    <div className="flex items-center gap-2 text-emerald-400 mb-1">
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <p className="text-zinc-400 text-sm">Account deletion available</p>
                  </div>
                </div>
              </div>
            </>
