          ...
          <div className="prose prose-invert prose-zinc max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 space-y-4">
                <div>
                  <h3 className="text-lg font-medium text-white mb-2">For Job Seekers:</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium text-white mb-2">For Employers:</h3>
                  <ul className="list-disc list-inside text-zinc-300 space-y-1">
                ...
                <div>
                  <h3 className="text-lg font-medium text-white mb-2">Automatically Collected:</h3>
                  <ul className="list-disc list-inside text-zinc-300 space-y-1">
            ...
            <section className="mb-8">
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
                <p className="text-zinc-300 mb-4">We may share your data with:</p>
                <ul className="list-disc list-inside text-zinc-300 space-y-2">
